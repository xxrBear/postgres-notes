...
## 目录
 ...
 | **数据库基础**                        | **数据库高级**            | **服务器管理**                  | **服务器编程** |
 | ------------------------------------- | ------------------------- | ------------------------------- | -------------- |
 | [PostgreSQL的起源](#PostgreSQL的起源) | [事务处理](#事务处理)     | [系统管理函数](#系统管理函数)   |                |
 | [安装数据库](#安装数据库)             | [显示锁定](#显示锁定)     | [命令行工具](#命令行工具)       |                |
 | [查询语句风格](#查询语句风格)         | [触发器](#触发器)         | [系统信息函数](#系统信息函数)   |                |
 | [常用数据类型](#常用数据类型)         | [存储过程](#存储过程)     | [查看运行参数](#查看运行参数)   |                |
 | [字段约束](#字段约束)                 | [模式管理](#模式管理)     | [修改运行参数](#自定义运行参数) |                |
 | [常用数据函数](#常用数据函数)         | [表分区](#表分区)         | [数据库管理](#数据库管理)       |                |
 | [常用表达式](#常用表达式)             | [角色管理](#角色管理)     | [数据库维护](#数据库维护)       |                |
 | [窗口函数](#窗口函数)                 | [行安全策略](#行安全策略) | [备份与恢复](#备份与恢复)       |                |
 | [视图](#视图)                         | [客户端认证](#客户端认证) | [预写式日志](#预写式日志)       |                |
 | [连接语句](#连接语句)                 | [索引](#索引)             | [复制](#复制)                   |                |
 | [权限管理](#权限管理)                 | [性能提示](#性能提示)     | [逻辑复制](#逻辑复制)           |                |
 |                                       | [功能扩展](#功能扩展)     |                                 |                |
...
数据来自[维基百科](https://zh.wikipedia.org/zh-cn/PostgreSQL)
